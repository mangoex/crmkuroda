...
class Cotizacion(Base):
    ...
    hora_facturacion = Column(String, nullable=True)
    margen = Column(Numeric(precision=10, scale=3), nullable=True)
    grupo_vendedores = Column(String, index=True, nullable=True)
    plazo_entrega = Column(String, nullable=True)
